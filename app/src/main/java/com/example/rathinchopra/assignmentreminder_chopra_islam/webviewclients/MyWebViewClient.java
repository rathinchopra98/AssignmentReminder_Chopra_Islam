...
public class MyWebViewClient extends WebViewClient {
    ...
    //SlateLoginActivity class
    private SlateLoginActivity slateLogin;

    //Constructor for this class
    //Parameters: WebView webView, SlateLoginActivity login
    public MyWebViewClient(WebView webView, SlateLoginActivity login){
